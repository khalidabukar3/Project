...
public class List3<T> extends ListSecondary<T> {
    ...
    private void createNewRep() {
        /*
         * Initialize preStart and postFinish to new Nodes.
         */
        this.preStart = new Node();
        this.postFinish = new Node();

        /*
         * Assign preStart's next to postFinish, and postFinish's previous to
         * preStart.
         */
        this.preStart.next = this.postFinish;
        this.postFinish.previous = this.preStart;

        // lastLeft is initially supposed to be preStart.
        this.lastLeft = this.preStart;

        // Initial lengths of left and right are zero.
        this.leftLength = 0;
        this.rightLength = 0;
    }
    ...
    public final void addRightFront(T x) {
        ...
        /*
         * Create a new current node to represent the added node.
         */
        Node current = new Node();
        /*
         * Set its data as x, its next as the node after lastLeft, and its
         * previous as the lastLeft node.
         */
        current.data = x;
        current.next = this.lastLeft.next;
        current.previous = this.lastLeft;
        /*
         * Set lastLeft's next as now being current, the node in the front of
         * this.right. Then, set the previous of the node to the right of
         * current as being current.
         */
        this.lastLeft.next = current;
    ...
    public final T removeRightFront() {
        ...
        // Create a variable to represent the soon-to-be removed node's data.
        T removed = this.lastLeft.next.data;
        /*
         * Set the previous reference of the node to the right of the node that
         * will soon-to-be removed, as lastLeft.
         */
        this.lastLeft.next.next.previous = this.lastLeft;
        /*
         * Make lastLeft's next reference to be node to the right of the
    ...
    public final void advance() {
        assert this.rightLength() > 0 : "Violation of: this.right /= <>";
        /*
         * Make lastLeft to be the node after the initial lastLeft, because
         * this.left has gained one node so the last left node is one more to
         * the right.
         */
        this.lastLeft = this.lastLeft.next;
        // Increment leftLength and decrement rightLength.
        this.leftLength++;
        this.rightLength--;
        assert this.conventionHolds();
    }
    ...
    public final void moveToStart() {
        // Set lastLeft reference to its initial pointing location, preStart.
        this.lastLeft = this.preStart;
        // Add the entire length of linked list to this.rightLength.
        this.rightLength += this.leftLength;
        // Reset leftLength to zero.
        this.leftLength = 0;
        assert this.conventionHolds();
    }
    ...
    public final void moveToFinish() {
        /*
         * Last left will be set to the last true node, which is the one before
         * postFinish.
         */
        this.lastLeft = this.postFinish.previous;
        // Add the entire length of linked list to this.leftLength.
        this.leftLength += this.rightLength;
        // Reset rightLength to zero.
        this.rightLength = 0;
        assert this.conventionHolds();
    }
    ...
    public final void retreat() {
        ...
        /*
         * Make lastLeft to be the node before the initial lastLeft, because
         * this.left has gained lost one node so the last left node is one more
         * to the left.
         */
        this.lastLeft = this.lastLeft.previous;
        // Increment rightLength and decrement leftLength.
        this.rightLength++;
        this.leftLength--;
        assert this.conventionHolds();
    }
