...
public abstract class ListTest {
    ...
    /**
     * Test case for retreat, with left having length 1, and right being empty.
     * Edge case because we are approaching left length of 0.
     */
    @Test
    ...
    /**
     * Test case for retreat, with left having length 3 and right being empty.
     */
    @Test
    public final void testRetreatLeftNonEmptyRightEmpty() {
         ...
         */
        final int three = 3;
        List<String> list1 = this.createFromArgsTest(three, "green", "red",
                "blue");
    ...
    /**
     * Test case for retreat, with left having length 1 and right having length
     * 2 (both non-empty). Edge case because approaching left length of 0.
     */
    @Test
    ...
    /**
     * Test case for retreat, with left having length 3 and right having length
     * 2 (both non-empty).
     */
    @Test
