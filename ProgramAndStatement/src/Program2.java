...
public class Program2 extends ProgramSecondary {
    ...
    public final void swapContext(Map<String, Statement> c) {
        ...
        /*
         * Make temp context, transfer c into tempContext, transfer this.context
         * into c, and transfer tempContext into this.context.
         */
    ...
    public final void swapBody(Statement b) {
        ...
        /*
         * Make tempBody, transfer b into tempBody, transfer this.body into b,
         * and transfer tempBody into this.context.
         */
