...
public final class ABCDGuesser2 {
    ...
    private static double jagerFormula(double mu, double w, double x, double y,
            double z) {
        ...
        for (int indexA = 0; indexA < deJager.length; indexA++) {
            for (int indexB = 0; indexB < deJager.length; indexB++) {
                for (int indexC = 0; indexC < deJager.length; indexC++) {
                    for (int indexD = 0; indexD < deJager.length; indexD++) {
